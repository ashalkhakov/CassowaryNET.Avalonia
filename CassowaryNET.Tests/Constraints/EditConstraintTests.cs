...
{
    [TestFixture]
    public class EditConstraintTests
    {
        #region Helpers
        ...
        public class Constructor_VariableStrengthTests //: TestBase
        {
            ...
            public void can_be_created()
            {
                ...
                var target = new EditConstraint(variable, strength);
                ...
                Assert.That(target.IsEditConstraint, Is.True);
        ...
        public class Constructor_VariableStrengthWeightTests //: TestBase
        {
            ...
            public void can_be_created()
            {
                ...
                var strength = Strength.Medium;
                var weight = 2.3d;
                var target = new EditConstraint(variable, strength, weight);
            ...
            {
                Assert.That(
                    () => new EditConstraint(null, Strength.Medium, 2.3d),
                    Throws.InstanceOf<ArgumentNullException>());
            ...
            public void when_strength_null_throws()
            {
                var variable = new Variable("test", 42.3d);
                Assert.That(
                    () => new EditConstraint(variable, null, 2.3d),
                    Throws.InstanceOf<ArgumentNullException>());
