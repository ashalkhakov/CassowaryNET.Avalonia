...
namespace AutoLayoutPanel
{
    public class AutoLayoutPanel : Panel
    {
        ...
        protected ClVariable FindClVariableByUIElementAndProperty(
            UIElement em,
            String property)
        {
        ...
        public int AddLayoutConstraint(
            ...
            double constant)
        {
            ...
            else
            {
                ...
                target.propertySecondVariable =
                    FindClVariableByUIElementAndProperty(controlSecond, propertySecond);
        ...
        {
            SetValue(
                FindClVariableByUIElementAndProperty(this, "Width"),
                finalSize.Width,
                ClStrength.Required);
            SetValue(
                FindClVariableByUIElementAndProperty(this, "Height"),
                finalSize.Height,
                ClStrength.Required);
            ...
            {
                SetValue(
                    FindClVariableByUIElementAndProperty(child, "Width"),
                    child.DesiredSize.Width,
                    ClStrength.Strong);
                SetValue(
                    FindClVariableByUIElementAndProperty(child, "Height"),
            ...
            foreach (UIElement child in InternalChildren)
            {
                ...
                child.Arrange(
                    new Rect(
                        new Point(
                            ((ClVariable) ControlVariables[Id + "_X"]).Value,
                            ((ClVariable) ControlVariables[Id + "_Y"]).Value),
                        new Size(
                            ((ClVariable) ControlVariables[Id + "_Width"]).Value,
